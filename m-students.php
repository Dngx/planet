    ...
    <div class="container-fluid">
        ...
        <div class="row text-start p-4 mb-auto" style="width:90%; margin: auto;">
            <div class="container ">
                ...
                <br><br>
                <p><h1 class="p-1 text-start" style="color: #3f51b5;">Manage students</h1></p><hr>
                <?php 
                ...
                <!-- butoni per shtimin e adminit -->
                    <div class="text-start"><a href="add-student.php" class="btn btn-primary btn-sm"><img src="img/icon-add-white.png" height="30" width="30"> Add student</a></div>
                    <br>
                <table class="table">
  <thead>
    <tr>
